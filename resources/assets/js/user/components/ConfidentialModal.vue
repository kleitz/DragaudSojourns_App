    ...
    <div class="panel-body">
      <form>
        ...
        <div class="flex-row-between" style="margin-top: 20px">
          <button id="reg-submit" type="button" name="submit" class="modal-ds-button button-gen waves-effect" value="Submit" @click="saveChanges">
      			Save changes
      		</button>
          <button id="reg-submit" type="button" name="submit" class="modal-ds-button button-cancel waves-effect" value="Submit" @click="closeMe">
      			Cancel
      		</button>
        </div>
      </form>
