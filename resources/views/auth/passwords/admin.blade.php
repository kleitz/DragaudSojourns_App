@extends('layouts.user.master', [
	'title' => 'Reset Admin Password | Dragaud Custom Sojourns',
	'header' => '',
	'authUsr' => 'reset@password'
])
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2 ">
            <div class="panel panel-default border-panel floating-div">
                <div class="panel-heading pwreset-heading">Reset Adminstrator Password</div>
                ...
                <div class="panel-body pwreset-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.password.request') }}">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <input id="password" type="password" class="form-control pass-format" name="password" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <input id="password-confirm" type="password" class="form-control pass-format" name="password_confirmation" required>
