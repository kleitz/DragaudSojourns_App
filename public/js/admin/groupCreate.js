...
var groupCreateApp = new Vue({
  ...
  methods: {
    ...
    groupValid: function groupValid() {
      if (this.group.number != '' && this.groupExists == false && this.group.destination != '' && this.group.depart != '' && this.group.return != '' && this.group.school != '' && this.checkPackages() == true && this.group.icon != '' && this.group.itinerary != '' && this.group.itinerary != undefined && this.group.release != undefined && this.group.release != '' && this.group.message != '') {
