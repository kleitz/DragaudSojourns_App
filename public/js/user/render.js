...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_TravelerModal_vue__ = __webpack_require__(70);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ConfidentialModal_vue__ = __webpack_require__(75);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_NewBookingModal_vue__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_NewPaymentModal_vue__ = __webpack_require__(89);
...
var accountApp = new Vue({
  ...
  methods: {
    userDetailsExpand: function userDetailsExpand() {
      $("#usr-name").focus();
      for (var i = 0; i < profileCx.length; i++) {
        $(profileCx[i]).addClass('opaque');
      }
      var link = $("#profile-expand");
      var el = this.userErr;
      var profileErr = [{ elem: el.name.e, type: el.name.t }, { elem: el.street.e, type: el.street.t }, { elem: el.zip.e, type: el.zip.t }];
      if (this.userDetails.home || !this.userDetails.cell && !this.userDetails.home) profileErr.push({ elem: el.home.e, type: el.home.t });
      if (this.userDetails.cell || !this.userDetails.cell && !this.userDetails.home) profileErr.push({ elem: el.cell.e, type: el.cell.t });
      var check = validator.isValid(profileErr);
    ...
    updateUserData: function updateUserData(check) {
      var acctApp = this;
      if (check == true) {
        $.ajax({
          type: "POST",
        ...
        for (var i = 0; i < check.length; i++) {
          for (var prop in this.userErr) {
            if (check[i] == this.userErr[prop].e) this.userErr[prop].v = true;
          }
        }
      }
    },
    ...
    emptyTraveler: function emptyTraveler() {
      var trav = this.userTravelers;
    ...
    removeNewTraveler: function removeNewTraveler() {
      var trav = this.userTravelers;
      setTimeout(function () {
        trav.pop();
      }, 400);
...
Component.options.__file = "C:\\Server\\www\\dragaudsojourns\\obs_master\\ds_app\\resources\\assets\\js\\user\\components\\TravelerModal.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-85c9fa46", Component.options)
  } else {
    hotAPI.reload("data-v-85c9fa46", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(4)("4e9fd9d7", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-85c9fa46\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./TravelerModal.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-85c9fa46\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./TravelerModal.vue");
  ...
  methods: {
    ...
    storeNew: function storeNew() {
      ...
      if (checkValid == true) {
        ...
        var curUser = this.traveler.user;
        $.ajax({
          type: "POST",
          url: '/newtraveler',
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "traveler-modal-container profile-traveler-modal shadow-mix",
    attrs: {
  ...
  }, [_vm._v("Name")]), _vm._v(" "), _c('div', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.traveler.name),
      expression: "traveler.name"
    }],
    staticClass: "inline-material-input",
    attrs: {
      "id": 'traveler-modal' + _vm.id + '-name',
      "type": "text",
      "name": "travname"
    },
    domProps: {
    ...
    on: {
      "keyup": function($event) {
        _vm.testError({
          elem: 'traveler-modal' + _vm.id + '-name',
          type: 'string'
        })
      },
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.traveler.name = $event.target.value
      }
    }
  }), _vm._v(" "), _c('span', {
  ...
  }, [_vm._v("Gender")]), _vm._v(" "), _c('div', [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.traveler.gender),
      expression: "traveler.gender"
    }],
    staticClass: "inline-material-input custom-select pointer",
    attrs: {
      "id": 'traveler-modal' + _vm.id + '-gender',
      "name": "travgender"
    },
    on: {
      "click": function($event) {
        _vm.testError({
          elem: 'traveler-modal' + _vm.id + '-gender',
          type: 'select'
        })
      },
      "change": function($event) {
        ...
        _vm.traveler.gender = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
  ...
  }, [_vm._v("Gender")]), _vm._v(" "), _vm._l((_vm.genderIn), function(input) {
    return _c('option', {
      domProps: {
        "value": input
      }
    ...
    staticClass: "text-left ds-form-errmsg",
    attrs: {
      "id": 'traveler-modal' + _vm.id + '-gender-err'
    }
  }, [_vm._v("Select their gender")])])]), _vm._v(" "), _c('div', {
    staticClass: "material-form-group flex-row-start"
  }, [_c('label', {
    attrs: {
      "for": "travrelation"
    }
  }, [_vm._v("Relationship")]), _vm._v(" "), _c('div', [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.traveler.relationship),
      expression: "traveler.relationship"
    }],
    staticClass: "inline-material-input custom-select  pointer",
    attrs: {
      "id": 'traveler-modal' + _vm.id + '-relate',
      "name": "travrelationship"
    },
    on: {
      "click": function($event) {
        _vm.testError({
          elem: 'traveler-modal' + _vm.id + '-relate',
          type: 'select'
        })
      },
      "change": function($event) {
        ...
        _vm.traveler.relationship = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    staticClass: "default-option",
  ...
  }, [_vm._v("Relationship")]), _vm._v(" "), _vm._l((_vm.relateIn), function(input) {
    return _c('option', {
      domProps: {
        "value": input
      }
    ...
    staticClass: "text-left ds-form-errmsg",
    attrs: {
      "id": 'traveler-modal' + _vm.id + '-relate-err'
    }
  }, [_vm._v("Select your relationship")])])]), _vm._v(" "), _c('h6', [_vm._v("Emergency contact")]), _vm._v(" "), _c('div', {
    staticClass: "material-form-group flex-row-start"
  }, [_c('label', {
    attrs: {
      "for": "travcontact"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.traveler.emerg_name),
      expression: "traveler.emerg_name"
    }],
    staticClass: "inline-material-input",
    attrs: {
      "id": 'traveler-modal' + _vm.id + '-emerg',
      "type": "text",
      "name": "travcontact"
    },
    domProps: {
    ...
    on: {
      "keyup": function($event) {
        _vm.testError({
          elem: 'traveler-modal' + _vm.id + '-emerg',
          type: 'string'
        })
      },
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.traveler.emerg_name = $event.target.value
      }
    }
  }), _vm._v(" "), _c('span', {
    staticClass: "text-left ds-form-errmsg",
    attrs: {
      "id": 'traveler-modal' + _vm.id + '-emerg-err'
    }
  ...
  }, [_vm._v("Phone")]), _vm._v(" "), _c('div', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.traveler.emerg_phone),
      expression: "traveler.emerg_phone"
    }],
    staticClass: "inline-material-input phone-format numbers-only",
    attrs: {
      "id": 'traveler-modal' + _vm.id + '-ephn',
      "type": "text",
      "name": "travcontphone"
    },
    domProps: {
    ...
    on: {
      "keyup": function($event) {
        _vm.testError({
          elem: 'traveler-modal' + _vm.id + '-ephn',
          type: 'phone'
        })
      },
      "click": _vm.formatTrav,
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.traveler.emerg_phone = $event.target.value
      }
    }
  }), _vm._v(" "), _c('span', {
    staticClass: "text-left ds-form-errmsg",
    attrs: {
      "id": 'traveler-modal' + _vm.id + '-ephn-err'
    }
  }, [_vm._v("Please enter a valid number")])])])]), _vm._v(" "), (_vm.traveler.created_at != '') ? _c('div', {
    ...
    on: {
      "click": _vm.undoChanges
    }
  }, [_vm._v("Undo changes")])]) : _vm._e(), _vm._v(" "), (_vm.traveler.created_at == '') ? _c('div', {
    staticClass: "flex-row-between"
  }, [_c('a', {
    staticClass: "free-link",
    attrs: {
  ...
  }, [_vm._v("Save traveler")]), _vm._v(" "), _c('a', {
    staticClass: "free-link",
    attrs: {
      "href": "javascript:;"
    },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-85c9fa46", module.exports)
  }
}
...
Component.options.__file = "C:\\Server\\www\\dragaudsojourns\\obs_master\\ds_app\\resources\\assets\\js\\user\\components\\ConfidentialModal.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] ConfidentialModal.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b73c6f88", Component.options)
  } else {
    hotAPI.reload("data-v-b73c6f88", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("254d47da", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b73c6f88\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ConfidentialModal.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b73c6f88\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ConfidentialModal.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__LoadingModal_vue__ = __webpack_require__(15);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("Change email / password")]), _vm._v(" "), _c('span', {
  ...
  }, [_vm._v("New email")]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    class: {
      'input-add-errparent': _vm.emailExists, 'register-input form-control': true
    },
    attrs: {
      "type": "text",
      "name": "email",
    ...
    on: {
      "keyup": _vm.verifyEmail,
      "change": _vm.verifyEmail,
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.resetData.email = $event.target.value
      }
    }
  }), _vm._v(" "), (_vm.emailExists == true) ? _c('div', {
    staticClass: "input-add-err"
  }, [_c('input', {
    staticClass: "ds-form-error ds-details-err",
    attrs: {
      "readonly": "",
      "type": "text",
      "value": "This email is being used by another user. Please choose another"
    }
  }), _vm._v(" "), _c('img', {
    ...
    staticClass: "form-control pass-format",
    attrs: {
      "type": "text",
      "name": "password",
      "id": "conf-password"
    ...
    on: {
      "keyup": _vm.testErrors,
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.resetData.password = $event.target.value
      }
    }
    ...
    attrs: {
      "id": "conf-password-err"
    }
  }, [_vm._v("Must be 8 characters long with one uppercase letter and one number.")])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    attrs: {
      "for": "passwordconf"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b73c6f88", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("625bf35c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("decf94a8", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    paypalErrorCheck: function paypalErrorCheck() {
      var payApp = this;
